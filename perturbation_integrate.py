...
def none_dX_dt(t, state, LVLH_orbit):
    ...
    #Acceleration vector - analytical version (See Bucher 18)
...
def perturb_orbit(LVLH_orbit,perturb_func):
    ...
    X_d1 = solve_ivp(lambda t, y: perturb_func(t,y,LVLH_orbit), [tspan[0],tspan[-1]], X0_d1, t_eval = tspan, rtol = rtol, atol = atol)
    X_d2 = solve_ivp(lambda t, y: perturb_func(t,y,LVLH_orbit), [tspan[0],tspan[-1]], X0_d2, t_eval = tspan, rtol = rtol, atol = atol)
