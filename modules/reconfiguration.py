...
Inputs:
    ECI1 - orbit configuration #1
    ECI2 - orbit configuration #2
Outputs:
    del_v1 - total delta v for deputy 1
    del_v2 - total delta v for deputy 2
"""
def del_v_reconfigure(ECI1,ECI2):
    ...
    #Normalise to a point on the orbit
    ...
    #Time of deputy 1 in configuration 1
    t_a1 = deputy_pos_to_time(ECI1,point1,ECI1.q1)
    #Time of deputy 2 in configuration 1
    t_a2 = deputy_pos_to_time(ECI1,point2,ECI1.q2)
    #Time of deputy 1 in configuration 2
    t_b1 = deputy_pos_to_time(ECI2,point1,ECI2.q1)
    #Time of deputy 2 in configuration 2
    t_b2 = deputy_pos_to_time(ECI2,point2,ECI2.q2)

    #Adjust if so that it's between 0 and the period.
    ...
    #Caclulate delta_v from plane change
