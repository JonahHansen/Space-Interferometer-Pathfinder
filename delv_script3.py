...
c, d1, d2, delv, tbank = delv_f.integration_fix(ref, c0, d10, d20, t0, t_final, t_burn, zeta)
...
print("Delv for orbit %s: "%ix + str(np.sum(np.append(delv,delv2,axis=0),axis=0)))
